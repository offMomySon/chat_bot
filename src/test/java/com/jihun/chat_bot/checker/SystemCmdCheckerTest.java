...
class SystemCmdCheckerTest {
    ...
    void test1() {
        ...
        //given
        SystemCmdChecker systemCmdChecker = new SystemCmdChecker("system");

        //when
        Throwable actual = Assertions.catchThrowable(() -> systemCmdChecker.createErrorMessage());
    ...
    void test2() {
        //given
        SystemCmdChecker systemCmdChecker = new SystemCmdChecker("system_not");

        //when
        CmdErrorMessage actual = systemCmdChecker.createErrorMessage();
    ...
    void test3() {
        ...
        //when
        Boolean actual = systemCmdChecker.isNotSupport();
